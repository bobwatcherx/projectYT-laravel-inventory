        ...
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">Penyuplai barang</h4>
                        </div>
                        <div class="col-4 text-right">
                            <a href="{{ route('providers.create') }}" class="btn btn-sm btn-primary">tambah penyuplai</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="">
                        <table class="table tablesorter " id="">
                            <thead class=" text-primary">
                                ...
                                <th scope="col">Pembayaran Terbuat</th>
